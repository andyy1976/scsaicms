...
<tr> 
 ...
 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr bgcolor="#fff" onMouseOver="this.style.backgroundColor='#EAFCD5';this.style.color='red'" onMouseOut="this.style.backgroundColor='';this.style.color=''">
    <td height="24" class="tdleft"><?php if(($vo["fid"]) == "0"): if(($vo["islink"]) != "1"): ?><a href="javascript:show_mydialog(<?php echo ($vo["typeid"]); ?>,'<?php echo ($vo["typename"]); ?>');"><img src='__PUBLIC__/Editor/themes/common/anchor.gif' border='0'></a><?php endif; endif; echo ($vo["space"]); ?><a href="__APP__/Article/index/typeid/<?php echo ($vo["typeid"]); ?>"><?php echo ($vo["typename"]); ?></a><font color="blue">
    ...
    <td height="24" align="center"><?php if(($vo["ismenu"]) == "1"): ?><font color="red"><?php else: ?><font color="green"><?php endif; echo ($vo["drank"]); ?></font></td>
	...
	<td height="24" align="center"><?php if(($vo["isindex"]) == "1"): echo ($vo["irank"]); else: ?>-<?php endif; ?></td>
