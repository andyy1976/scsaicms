...
$admin_config=array(
   // 'SHOW_PAGE_TRACE' => true, 
	...
	'USER_CONTENT_KEY'=>'conids',//conids
  ...
  'TMPL_ACTION_SUCCESS' => 'Public:success',
	'FIELD_TYPE' => array(0=>'单行文本(text)',1=>'多行文本不支持编辑器(textarea)',
												2=>'多行文本支持编辑器(htmleditor)',3=>'下拉列表菜单(select)',
												4=>'单选按钮(radio)',5=>'多选列表(multselect)',
												6=>'多选按钮(checkbox)',7=>'单文件上传(file)',
												8=>'多文件上传(multifile)'),
												//8=>'多文件上传(multifile)',9=>'地址选择器(address)'),
);
