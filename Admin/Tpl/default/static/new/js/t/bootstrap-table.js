(function (global, factory) {
  ...
  (function ($) {
    ...
    LOCALES['en-US'] = LOCALES.en = {
      ...
      formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows, totalPages) {
        // return 'Showing ' + pageFrom + ' to ' + pageTo + ' of ' + totalRows + ' rows';
        return '共 ' +totalPages +'页，'+ totalRows + ' 条记录 跳转到第'+ `<input type='text' class='assignpage' /> `+'页';
    ...
    var BootstrapTable = function () {
      ...
      _createClass(BootstrapTable, [{
        ...
        value: function initPagination() {
          ...
          var paginationInfo = o.onlyInfoPagination ? o.formatDetailPagination(o.totalRows) : o.formatShowingRows(this.pageFrom, this.pageTo, o.totalRows, o.totalPages);
