...
');
    ...
    public static function v0_6r9_4_3($db, $options)
    {
        ...
        try {
            switch (true) {
                ...
                case false !== strpos($adapterName, 'SQLite'):
                    $uid = uniqid();
                    $db->query('CREATE TABLE ' . $prefix . 'users_' . $uid . ' ( "id" INTEGER NOT NULL PRIMARY KEY,
            ...
            "authCode" varchar(64) default NULL)', Typecho_Db::WRITE);
                    $db->query('INSERT INTO ' . $prefix . 'users_' . $uid . ' ("id", "name", "userpwd", "email", "url"
                    , "screenName", "created", "activated", "logged", "group", "authCode") SELECT "id", "name", "userpwd", "email", "url"
                    ...
                    $db->query('CREATE TABLE ' . $prefix . 'users ( "id" INTEGER NOT NULL PRIMARY KEY,
            "name" varchar(32) default NULL ,
            "userpwd" varchar(64) default NULL ,
            "email" varchar(200) default NULL ,
            "url" varchar(200) default NULL ,
            ...
            "group" varchar(16) default \'visitor\' ,
            "authCode" varchar(64) default NULL)', Typecho_Db::WRITE);
                    $db->query('INSERT INTO ' . $prefix . 'users SELECT * FROM ' . $prefix . 'users_' . $uid, Typecho_Db::WRITE);
                    $db->query('DROP TABLE  ' . $prefix . 'users_' . $uid, Typecho_Db::WRITE);
                    $db->query('CREATE UNIQUE INDEX ' . $prefix . 'users_name ON ' . $prefix . 'users ("name")', Typecho_Db::WRITE);
                    $db->query('CREATE UNIQUE INDEX ' . $prefix . 'users_mail ON ' . $prefix . 'users ("email")', Typecho_Db::WRITE);
                    $db->flushPool();
        ...
        try {
            switch (true) {
                ...
                case false !== strpos($adapterName, 'SQLite'):
                    $uid = uniqid();
                    $db->query('CREATE TABLE ' . $prefix . 'contents' . $uid . ' ( "cid" INTEGER NOT NULL PRIMARY KEY,
        ...
        "allowFeed" char(1) default \'0\' )', Typecho_Db::WRITE);
                    $db->query('INSERT INTO ' . $prefix . 'contents' . $uid . ' SELECT * FROM ' . $prefix . 'contents', Typecho_Db::WRITE);
        ...
        "allowPing" char(1) default \'0\' ,
        "allowFeed" char(1) default \'0\' )', Typecho_Db::WRITE);
                    $db->query('INSERT INTO ' . $prefix . 'contents SELECT * FROM ' . $prefix . 'contents' . $uid, Typecho_Db::WRITE);
                    $db->query('DROP TABLE  ' . $prefix . 'contents' . $uid, Typecho_Db::WRITE);
                    ...
                    $db->query('CREATE TABLE ' . $prefix . 'metas' . $uid . ' ( "mid" INTEGER NOT NULL PRIMARY KEY,
        ...
        "order" int(10) default \'0\' )', Typecho_Db::WRITE);
                    $db->query('INSERT INTO ' . $prefix . 'metas' . $uid . ' SELECT * FROM ' . $prefix . 'metas', Typecho_Db::WRITE);
        ...
        "count" int(10) default \'0\' ,
        "order" int(10) default \'0\' )', Typecho_Db::WRITE);
                    $db->query('INSERT INTO ' . $prefix . 'metas SELECT * FROM ' . $prefix . 'metas' . $uid, Typecho_Db::WRITE);
                    $db->query('DROP TABLE  ' . $prefix . 'metas' . $uid, Typecho_Db::WRITE);
    ...
    public static function v0_7r9_9_27($db, $options)
    {
        ...
        $author = array (
            'url' => '/author/[id:digital]/',
            'widget' => 'Widget_Archive',
            'action' => 'render',
        );

        $author_page = array (
            'url' => '/author/[id:digital]/[page:digital]/',
            'widget' => 'Widget_Archive',
            'action' => 'render',
        );
...
"parent" int(10) default \'0\' )', Typecho_Db::WRITE);
                ...
                , "text", "order", "authorId", "template", "type", "status", "userpwd", "commentsNum", "allowComment",
...
"parent" int(10) default \'0\' )', Typecho_Db::WRITE);
  ...
  "float_value" real default \'0\'
    ...
    public function v0_9r14_2_24($db, $options)
    {
        ...
        "order" int(10) default \'0\' ,
        "parent" int(10) default \'0\')', Typecho_Db::WRITE);
                $db->query('INSERT INTO ' . $prefix . 'metas' . $uid . ' ("mid", "name", "slug", "type", "description", "count", "order") 
