					...
					<div class="row footer-info mb-60"> 
									...
									<ul class="link-small"> 
										...
										<li><a><i class="ion-ios-telephone fa-icons"></i>+86.12345678901</a></li>
										 ...
										 <div class="icons-hover-black"> 
										 	<a class="social weixin" href="javascript:"><img class="qrcode" src="__TMPL__images/we_chat.jpg" alt="微信二维码"> <i class="fa fa-weixin" aria-hidden="true"></i></a> 
								...
								<div class="col-md-2 col-sm-3 col-xs-12 mb-sm-30"> 
									...
									<ul class="link blog-link"> 
										...
										<li><a href="{:url('lists',17)}"><i class="fa fa-angle-double-right"></i> 品牌故事</a></li> 
										<li><a href="{:url('lists',22)}"><i class="fa fa-angle-double-right"></i> 产品列表</a></li> 
										<li><a href="{:url('lists',18)}"><i class="fa fa-angle-double-right"></i> 新闻动态</a></li> 
										<li><a href="{:url('lists',27)}"><i class="fa fa-angle-double-right"></i> 技术服务</a></li> 
										</ul> 
								</div> 
								<div class="col-md-3 col-sm-5 col-xs-12 mb-sm-30"> <h4 class="mb-30">最新动态</h4> 
									<div class="widget-details link"> <div class="post-type-post media"> 
										...
										<div class="post-content media-body"> 
											<p class="entry-title"><a href="http://www.qiruanwang.com/index.php?s=/articles/132.html">律伯网新版上线了</a></p> 
											<p class="entry-title"><a href="http://www.qiruanwang.com/index.php?s=/articles/132.html">律伯网新版上线了</a></p> 
											<p class="entry-title"><a href="http://www.qiruanwang.com/index.php?s=/articles/131.html">律伯网系统全新发布</a></p> 
											<p class="entry-title"><a href="http://www.qiruanwang.com/index.php?s=/articles/131.html">律伯网系统全新发布</a></p> 
										</div> 
									</div> 
								...
								<div class="col-md-4 col-sm-12 col-xs-12 mt-sm-30 mt-xs-30">
														 <div class="newsletter"> 
														 	<h4 class="mb-30">订阅律伯网</h4> 
														 		<p>我们提供各种各样的 <a href="http://www.qiruanwang.com/index.php?s=/lists/100.html"><span sytle="color:white;">联系方式</span></a></p> 
														 		<p> <br /></p>
														 	 <p>您还可以通过邮件订阅我们，</p> 
