                ...
                <div id="<?php $this->respondId(); ?>" class="respond" style="width:100%;">
                    ...
                    <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form">
                        <?php if($this->user->hasLogin()): ?>
                            <p>登录为 <a href="<?php $this->options->profileUrl(); ?>"><?php $this->user->screenName(); ?></a>. <a href="/index.php?s=/member/dologout.html" title="Logout"><?php _e('退出'); ?> &raquo;</a></p>
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <p style="width:100%;">
                            <textarea rows="5" name="text" id="textarea" placeholder="在这里输入你的评论..." style="resize:none;width:100%;"><?php $this->remember('text'); ?></textarea>
