		...
		<div class="second-left">
			<div class="left-list">
				<div class="second-treemenu">
		           ...
		           <li><span class="arrow"></span><span class="file"><a href="#" onclick='topbuttonclicked("/blog/admin/index.php");'>我的文章</a></span></li>
		           <?php endif?>
		           <li><span class="arrow"></span><span class="file"><a href="#" onclick='topbuttonclicked("/index.php?s=memberlist");'>团队展示</a></span></li>
		        	</ul>
		  	 	  </div>
				</div>
				<div class="second-treemenu">
