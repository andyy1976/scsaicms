		...
		<div class="second-left">
			<div class="left-list">
				<div class="second-treemenu">
		           ...
		           <li><span class="arrow"></span><span class="file active"><a href="/blog/admin/index.php">我的文章</a></span></li>
		           <?php endif?>
			...
			<div class="second-right">
					<div class="tw-menu">
															                ...
															                <ul >
															                	 <li><a href="<?php $options->adminUrl('index.php'); ?>"><?php _e('最近发布的文章'); ?></a></li>
																                	  <li class="active"><a href="<?php $options->adminUrl('comments_recent.php'); ?>"><?php _e('最近得到的回复'); ?></a></li>
															                    ...
															                    <ul>
															                        ...
															                        <li>
															                            ...
															                            <?php $comments->excerpt(35, '...'); ?>
																																...
																																<div style="float:right;"> [<span><?php $comments->date('n.j'); ?></span>]</div>
																															</div>
