                ...
                <div class="typecho-table-wrap">
                    <table class="typecho-list-table">
                        ...
                        <tbody>
                            ...
                            <tr id="user-<?php $users->id(); ?>">
                                <td><input type="checkbox" value="<?php $users->id(); ?>" name="id[]"/></td>
                                <td><a href="<?php $options->adminUrl('manage-posts.php?id=' . $users->id); ?>" class="balloon-button left size-<?php echo Typecho_Common::splitByCount($users->postsNum, 1, 10, 20, 50, 100); ?>"><?php $users->postsNum(); ?></a></td>
                                <td><a href="<?php $options->adminUrl('user.php?id=' . $users->id); ?>"><?php $users->username(); ?></a>
                                <a href="<?php $users->permalink(); ?>" title="<?php _e('浏览 %s', $users->screenName); ?>"><i class="i-exlink"></i></a>
                                </td>
                                <td><?php $users->screenName(); ?></td>
                                <td><?php if($users->email): ?><a href="mailto:<?php $users->email(); ?>"><?php $users->email(); ?></a><?php else: _e('暂无'); endif; ?></td>
