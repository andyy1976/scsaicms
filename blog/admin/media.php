...
<div class="width-block">
		<div class="pusl-list">
								<div class="joint"><span>你的位置：首页 >  专家页面 > <a href="<?php $options->adminUrl('index.php'); ?>">我的文章</a> > <a href="<?php $options->adminUrl('manage-medias.php'); ?>">文件管理</a> > 编辑文件   <!-- <?php echo "<a href=\"{$menu->addLink}\">" . _t("新增") . "</a>"; ?>--></span></div>
								<div class="bule"></div>
<div class="main">
