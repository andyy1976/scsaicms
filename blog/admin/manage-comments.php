...
<div class="width-block">
		<div class="pusl-list">
								<div class="joint"><span>你的位置：首页 >  专家页面 > <a href="<?php $options->adminUrl('index.php'); ?>">我的文章</a> > 管理评论   <!-- <?php echo "<a href=\"{$menu->addLink}\">" . _t("新增") . "</a>"; ?>--></span></div>
								<div class="bule"></div>
<div class="main">
    <div class="body container" >
        ...
        <div class="row typecho-page-main" role="main">
            <div class="col-mb-12 typecho-list">
									...
									<div class="tw-menu" style="font-size:16px;">
                ...
                <div class="typecho-list-operate clearfix" style="font-size:16px;">
                    <form method="get">
                        <div class="operate">
                ...
                <div class="typecho-table-wrap">
                    <table class="typecho-list-table" style="font-size:14px;">
                        <colgroup>
                            <col width="3%"/>
                            <col width="6%" />
                            <col width="20%"/>
                        ...
                        ?>">
                            ...
                            <td valign="top" class="comment-head">
                                <div class="comment-meta">
                                    ...
                                    <?php if($comments->email): ?>
                                    <br /><span><a href="mailto:<?php $comments->email(); ?>"><?php $comments->email(); ?></a></span>
                                    <?php endif; ?>
                                    <?php if($comments->ip): ?>
...
$(document).ready(function () {
    ...
    $('.operate-edit').click(function () {
        ...
        var edit = $('<tr class="comment-edit"><td> </td>'
                        ...
                        + '<input class="text-s w-100" type="email" name="email" id="' + id + '-mail"></p>'
        ...
        $('input[name=email]', edit).val(comment.email);
        ...
        $('form', edit).submit(function () {
            ...
            var html = '<strong class="comment-author">'
                ...
                + (comment.email ? '<br /><span><a href="mailto:' + comment.email + '">'
                + comment.email + '</a></span>' : '')
