...
<div class="width-block">
		<div class="pusl-list">
								<div class="joint"><span>你的位置：首页 >  专家页面 > <a href="<?php $options->adminUrl('index.php'); ?>">我的文章</a> > 文件管理   <!-- <?php echo "<a href=\"{$menu->addLink}\">" . _t("新增") . "</a>"; ?>--></span></div>
								<div class="bule"></div>
<div class="main">
        ...
        <div class="row typecho-page-main" role="main">
            <div class="col-mb-12">
                ...
                <div class="typecho-table-wrap">
                    <table class="typecho-list-table draggable" style="font-size:16px;">
                        <colgroup>
                            <col width="20"/>
                            <col width="6%"/>
                            <col width="30%"/>
