...
<div class="width-block">
		<div class="pusl-list">
								<div class="joint"><span>你的位置：首页 >  专家页面 > <a href="/blog/admin/index.php">我的文章</a> > 撰写(编辑）文章   <!-- <?php echo "<a href=\"{$menu->addLink}\">" . _t("新增") . "</a>"; ?>--></span></div>
								<div class="bule"></div>
<div class="main">
    <div class="body container">
        ...
        <div class="row typecho-page-main typecho-post-area" role="form">
            <form action="<?php $security->index('/action/contents-post-edit'); ?>" method="post" name="write_post">
            	    ...
            	    <div id="edit-secondary" class="col-mb-12 col-tb-12" role="complementary">
                    ...
                    <div id="tab-advance" class="tab-content">
                        ...
                        <section class="typecho-post-option">
                            <label for="token-input-tags" class="typecho-label"><?php _e('添加标签'); ?></label>
                            <p><input id="tags" name="tags" type="text" value="<?php $post->tags(',', false); ?>" class="w-100 text" /></p>
                        </section>
 												
 												 <section class="typecho-post-option">
 												 <label for="trackback" class="typecho-label"><?php _e('添加附件'); ?></label>
                        ...
                        <section class="typecho-post-option">
                            <p class="description">
                                ...
                                Typecho_Common::url('manage-posts.php?id=' . $post->author->id, $options->adminUrl), $post->author->screenName); ?><br>
