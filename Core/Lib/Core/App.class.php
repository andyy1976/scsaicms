...
class App {
    ...
    static public function init()
    {
        ...
        if(cookie('force_template') != 1)
				{
           if(check_wap() && cookie('think_template') != C('DEFAULT_WAP_THEME')){cookie('think_template',C('DEFAULT_WAP_THEME'));} elseif(!check_wap() && cookie('think_template') != C('DEFAULT_THEME')){cookie('think_template',C('DEFAULT_THEME'));}
        }
