...
<div class="list-banner">
    <div class="list-banner-bg">
        <img src="__TMPL__images/c2banner.jpg" alt="<?php echo (($type["typename"])?($type["typename"]):'SCSAI ContentOS'); ?>">
        <div class="list-banner-overlay"></div>
    </div>
    <div class="list-banner-content">
        <div class="container">
            <nav class="breadcrumb">
                <a href="/">首页</a>
                <span class="sep">/</span>
                <span class="current"><?php echo ($type["typename"]); ?></span>
            </nav>
            <h1 class="page-title"><?php echo ($type["typename"]); ?></h1>
            <p class="page-desc"><?php echo (($type["description"])?($type["description"]):'AI驱动的数字员工平台，重新定义内容生成与获客'); ?></p>
        </div>
    </div>
</div>
            ...
            <aside class="list-sidebar">
                <div class="sidebar-section">
                    ...
                    <nav class="sidebar-nav">
                        <?php $fid = get_field('type','typeid='.$type['typeid'],'fid'); if($fid == 0) { $pid = $type['typeid']; } else { $pid = $fid; } ?>
                        <?php $result=M('type')->where("fid=$pid and 1=1")->order("drank asc")->select();if(is_array($result)): $i = 0;foreach($result as $key=>$vo):++$i;?><a href='<?php echo (url(lists,$vo["typeid"])); ?>' class="nav-item <?php if($type['typeid'] == $vo['typeid']){ ?>active<?php } ?>">
                                <?php echo ($vo["typename"]); ?>
                ...
                <div class="sidebar-section contact-section">
                    ...
                    <div class="contact-info">
                        ...
                        <div class="contact-item">
                            <span class="icon">📧</span>
                            <span>contact@scsaiclaw.com</span>
                        </div>
                    </div>
                </div>
            </aside>
            ...
            <main class="list-content">
                    ...
                    <article class="single-article">
                        <header class="article-header">
                            ...
                            <div class="article-meta">
                                <span class="date">📅 <?php echo (msubstr($list[0]['addtime'],0,10)); ?></span>
                                <span class="author">👤 <?php echo (($list[0]['author'])?($list[0]['author']):'SCSAI'); ?></span>
                            </div>
                        </header>
                ...
                <?php }else{ ?>
                    ...
                    <div class="article-list">
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><article class="article-card">
                                <a href='<?php echo (url(articles,$vo["aid"])); ?>' class="card-link">
                                    <div class="card-image">
                                        <?php $img = $vo['imgurl'] ? '__ROOT__'.$vo['imgurl'] : '__TMPL__images/c2banner.jpg'; ?>
                                        <img src="<?php echo ($img); ?>" alt="<?php echo ($vo["title"]); ?>" onerror="this.src='__TMPL__images/c2banner.jpg'">
                                    </div>
                                    <div class="card-content">
                                        <h3 class="card-title"><?php echo ($vo["title"]); ?></h3>
                                        <p class="card-desc"><?php echo (msubstr($vo["description"],0,120,'utf-8')); ?></p>
                                        <div class="card-footer">
                                            <span class="card-date"><?php echo (msubstr($vo["addtime"],0,10)); ?></span>
...
.list-banner-overlay {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(135deg, rgba(26, 31, 78, 0.85) 0%, rgba(45, 27, 105, 0.75) 100%);
}
