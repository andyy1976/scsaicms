               ...
               <div class="he_synavul fl">
                      ...
                      <div class="he_synavli fl  one">
	               			...
	               			<?php if(is_array($menu)): $k = 0; $__LIST__ = array_slice($menu,0,7,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="he_synavli fl ">
			                           ...
			                           <div class="he_sypcuna he_xzdwm">
                                        ...
                                        <div class="he_sypubt">
                                            <img src="__TMPL__images/h1pdxa.jpg">
                                        </div>
                                    </div>
                    ...
                    <div class="he_ipho clearfix fl">
                        <div class="he_iphoim fl">
                            <img src="__TMPL__images/heaph1.png" class="he_img">
                            <img src="__TMPL__images/heaph.png" class="he_img1">
                        </div>
                    ...
                    <div class="he_sear fl">
                        <div class="he_searig">
                            <img src="__TMPL__images/heaser.png" class="he_img">
                            <img src="__TMPL__images/heaser1.png" class="he_img1">
                        </div>
                                 ...
                                 <form class="form" id="search" method="post" action="<?php echo U('Search/Index');;?>" role="search">
                                    <div class="mc_msc_box">
                                        ...
                                        <div class="mc_msc_submit" >
                                        	<button id="search_btn" type="submit"> <img src="__TMPL__images/heaser1.png"></button>
...
<div id="obtn">
    <div class="slideBoxBg wow fadeInUp">
        <div class="container2">
            <div class="pz_SideLayerNews">
									...
									<?php $result=M('type')->where("fid=$pid and 1=1")->order("drank asc")->select();if(is_array($result)): $i = 0;foreach($result as $key=>$vo):++$i;?><li class="l1 <?php if($type['typeid'] == $vo['typeid']){ ?>  on <?php } ?>">
            ...
            <div class="l1 searchBox newskuang">
							<p>咨询热线：13661068044,微信同号</p>
                <!---form action="/plus/search.php" name="formsearch">
                <input type="hidden" name="typeid" value="32"> 
                <input id="search-keyword" name="q"  type="text" type="text" placeholder="请输入搜索内容" id="searchText" autocomplete="off">
                <button id="searchBtn" type="submit" name="submit">搜索</button>
               </form--->
            </div>
        </div>
    </div>
...
<div id="obtn">
    <div class="container2">
        <div class="pageNewsList wow fadeInLeft">
        	
        			<div class="curLocation wow fadeInUp">你的位置：<?php echo ($nav); ?>   </div>
		          
										&nbsp;
		           
		           <div class="tH1 wow fadeInUp"> 
		        		<h1><?php echo ($article["title"]); if(isset($nowpage)): ?>(<?php echo ($nowpage); ?>)<?php endif; if(!empty($article["titlecolor"])): ?></font><?php endif; ?> <?php if(isset($nowpage)): ?>(<?php echo ($nowpage); ?>)<?php endif; ?></h1>
		        	</div>
		        		&nbsp;
						  <div class="curLocLabel wow fadeInUp">
	                <span><img src="/Web/Tpl/qrw/images/new8.png"/> &nbsp;SuperCloud</span>
	                <span><img src="/Web/Tpl/qrw/images/new9.png"/> &nbsp;<?php echo ($article["addtime"]); ?></span>
	                <span><img src="/Web/Tpl/qrw/images/new7.png"/> &nbsp;<?php echo ($article["keywords"]); ?></span>
	            </div>
											
    
						&nbsp;
            
             <div class="pageNewsText wow fadeInUp">		
             	<?php echo ($article["content"]); ?>
             	
             	
		             	 <div class="pageFy wow fadeInUp">
		                <div class="leftFy">
		                   <?php echo ($page); ?>
		                </div>
		                <div class="rightFy">
        ...
        <div class="pageHotNews wow fadeInRight">
            <div class="newsH1 wow fadeInUp">热门文章 <img src="/Web/Tpl/qrw/images/new1.png" alt="热门文章"/></div>
            <ul class="wow fadeInUp">
                       
										<?php $number=1 ?>
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
											 <a href='/index.php?s=article&aid=<?php echo ($vo["aid"]); ?>' target='_blank'>
                        <h4><?php echo (msubstr($vo["title"],0,38,'utf-8')); ?></h4>
                        <div class="p1"><?php echo (msubstr($vo["title"],0,100,'utf-8')); ?>...</div>
