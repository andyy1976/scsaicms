        ...
        <div class="he_ny he_c2bx he_main he_pulma">
            ...
            <div class="he_plucnav">
                ...
                <div class="he_plnavul he_common">
                				 	...
                				 	{php}
									//	$first_id=get_first_father($type['typeid']);
								  ...
								  {/php}
									<?php $result=M('type')->where("fid=$pid and 1=1")->order("drank asc")->select();if(is_array($result)): $i = 0;foreach($result as $key=>$vo):++$i;?><div class="he_plnavli {php}if($type['typeid'] == $vo['typeid']){{/php}  yxnav_active2 {php}}{/php} ">
										...
										<h2>	<a href='<?php echo (url(lists,$vo["typeid"])); ?>'><?php echo ($vo["typename"]); ?></a></h2>
												...
												<div class="he_plnavli">
													<ul>
														<?php $result=M('type')->where("fid=$vo[typeid] and 1=1")->order("drank asc")->select();if(is_array($result)): $i = 0;foreach($result as $key=>$voo):++$i;?><li><span class="file {php}if($type['typeid'] == $voo['typeid']){{/php}  active {php}}{/php}"><a href='<?php echo (url(lists,$voo["typeid"])); ?>' ><?php echo ($voo["typename"]); ?>(<?php echo $countofcurrenttypeid ?>)</a></span></li><?php endforeach;endif;?>
													</ul>
													</div>
												{php}}{/php}
			                ...
			                <div class="he_common">
			                    ...
			                    <div class="he_e1p1bx">
			                        ...
			                        <div class="he_e1p1ul">
																					...
																					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>{php}$idnumber= $idnumber+1;{/php}
