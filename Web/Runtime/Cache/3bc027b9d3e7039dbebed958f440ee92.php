    ...
    <div class="he_bannigul">
        ...
        <div class="he_bannigli">
            ...
            <div class="he_banig">
                ...
                <img src="/Public/Uploads/uploadfile/images/szzcbanner.webp" alt="szzcbanner.webp" class="he_banpc">
            ...
            <div class="he_bante he_common">
                ...
                <div class="he_bantepy">
                    ...
                    <div class="he_bantep3v">
                        ...
                        <p>打造以质量过程、工艺以及三维模型为核心数据的数据资产管理平台,构建基于海量数据的采集、汇聚、分析、协同和服务体系。</p>
                    ...
                    <div class="he_bantemo clearfix">
                        ...
                        <div class="he_bantemoli he_bantemoli1 fl">
                             ...
                             <a href="http://114.113.153.160/sjzcpt/login#" class="clearfix">
                                        ...
                                        <div class="he_c2p1lbri fl">
                                            ...
                                            <div class="he_b3p6lic2n">
                                                <div class="he_c2p1leti">
                                                    ...
                                                    <h4> 缺乏平台导致数据使用有滞后和延时</h4>
    
                                                </div>


                                                <div class="he_b3p6li clearfix"><div class="he_b3p6lile fl"><img src="__TMPL__images/b2ic_01.png"/></div><div class="he_b3p6liri fl"><p><span style=""><span style="">IT<span style="">缺乏统一的数据平台化管理，导致数据使用有滞后和延时</span></span></span></p><p><br/></p></div></div><p><br/></p>
                                            </div>
                                    ...
                                    <div class="he_c2p1lbx clearfix">
                                        ...
                                        <div class="he_c2p1lbri fl">
                                            ...
                                            <div class="he_b3p6lic2n">
                                                ...
                                                <div class="he_b3p6li clearfix"><div class="he_b3p6lile fl"><img src="__TMPL__images/b2ic_01.png"/></div><div class="he_b3p6liri fl"><p><span style=""><span style=""><span style="">数据质量层次不齐，数据价值得不到释放。</span></p><p><br/></p></div></div><p><br/></p>
                                            </div>
                    ...
                    <div class="he_common">
                        ...
                        <div class="he_b2p1bx">
                            ...
                            <div class="he_bap1tp wow g_fadeup1">
                                ...
                                <p>SCIOT<span style="">工业互联网平台数据资产管理系统系统，通过构建集数据资源关系采集、存储、计算、管理、服务于一体的数据平台，实现数据资产的整体概览、统计分析、溯源分析、影响分析等基本功能，形成一套结构清晰、覆盖全面的企业数据资产统一视图。对数据资产进行集中可视化管理，促进数据融合、共享、应用及价值变现，搭建数据资产管理系统、构建功能集，支撑数据资产全寿命周期管理，实现数据从实体管理向价值管理转变。数据资产管理系统系统支持与指标管理系统、分布式计算平台的融合和集成。该产品通过与指标管理平台有效融合，将枯燥的结构数 据驱动业务产生价值， 形成数据资产可视化。为了保证数据有效性和可用性， 数据资产平台提供数据标准、数据质量、数据规范，分布式计算平台提供统一的数据提取、数据治理、数据计算服务，实现平台与各个模块的高效协同运作机制，全面提升精益化管理水平</p><p><br/></p>
                            </div>
                     ...
                     <div class="he_b2p2 he_c2p3" yxdatop-pags="3">
                        ...
                        <div class="he_b2p2bx">
                            ...
                            <div class="he_b2p2ig wow g_fadeup1">
                                ...
                                <img src="/Public/Uploads/uploadfile/images/szzcarchitecture.png" alt="szzcarchitecture.png">
                           ...
                           <div class="he_c2p4" yxdatop-pags="4">
					                          	          ...
					                          	          <div class="he_c2p4gli clearfix">
					                                            ...
					                                            <div class="he_c2p4glle fl">
					                                                ...
					                                                <div class="he_c2p4glp1 wow g_fadeup1">
					                                                    ...
					                                                    <p>借助智能算法、人工智能技术手段，解决数据资源关系智能识别问题，提供基于SQL脚本的源表与目标表映射关系识别、基于SQL脚本的源字段与目标字段映射关系识别、宽表构建过程中源表与目标表的映射关系管理、宽表构建过程中源字段与目标字段的映射关系管理、指标计算源表与目标表的映射关系管理及指标计算源字段与目标字段的映射关系管理，实现基于数据特征的数据表之间主外键关系自动发现、基于数据特征的数据表之间关联关系自动发现算法</p>
					                                        ...
					                                        <div class="he_c2p4gli clearfix">
					                                            ...
					                                            <div class="he_c2p4glle fl">
					                                                ...
					                                                <div class="he_c2p4glp1 wow g_fadeup1">
					                                                    ...
					                                                    <p>构建数据资源关系知识库，包括专有词库、模型管理、文本解析、知识融合及实例化任务管理等内容，解决对领域业务概念、关系和属性进行统一管理，包括概念词库、关系词库、属性词库、生成脚本等，能够对半结构化、非结构化数据信息进行解析，通过智能融合算法，融合来自多个数据来源的知识在统一规范下进行异构数据整合、消歧，并可根据版本及分类对知识库进行维护管理。</p>
					                                        ...
					                                        <div class="he_c2p4gli clearfix">
					                                            ...
					                                            <div class="he_c2p4glle fl">
					                                                ...
					                                                <div class="he_c2p4glp1 wow g_fadeup1">
					                                                    ...
					                                                    <p>利用图谱结构展示数据资源关系，并可智能的进行云图配置、云图方案管理及云图展示功能，通过技术手段降低用户对数据资源关系的认知门槛，通过可视化的方式直观简介展示跨业务跨系统间的数据资源关系。</p>
					                                            ...
					                                            <div class="he_c2p4glri fr wow g_fadein1">
					                                                ...
					                                                <img src="/Public/Uploads/uploadfile/images/3.png" alt="3.png">
					                                        ...
					                                        <div class="he_c2p4gli clearfix">
					                                            ...
					                                            <div class="he_c2p4glle fl">
					                                                ...
					                                                <div class="he_c2p4glp1 wow g_fadeup1">
					                                                    ...
					                                                    <p>针对智能识别出的数据资源关系为用户提供检索查询功能，可提供关键字检索、多维度条件检索、过滤条件多选、移除、重置、查询结果列表展示、数据资源关系列表查看及数据资源关系详情查看等内容。 </p>
					                                        ...
					                                        <div class="he_c2p4gli clearfix">
					                                            ...
					                                            <div class="he_c2p4glle fl">
					                                                ...
					                                                <div class="he_c2p4glp1 wow g_fadeup1">
					                                                    ...
					                                                    <p>用户根据需求选择需要共享的元数据集合，对平台管理员发起共享审批流程，平台管理员审核通过后，用户可根据需求对选择的元数据进行共享操作（平台当前支持元数据的 Excel 导出、元数据分析结果（影响分析、血缘分析、全链分析）图片导出两种共享操作），同时平台支持查看导出历史记录及详情。产品后续的升级将增强用户导出文件的效率，提升审批用户共享数据申请的效率。</p>
					                                        ...
					                                        <div class="he_c2p4gli clearfix">
					                                            ...
					                                            <div class="he_c2p4glle fl">
					                                                ...
					                                                <div class="he_c2p4glp1 wow g_fadeup1">
					                                                    ...
					                                                    <p>在检索元数据列表中，对选中元数据，在右侧操作列，点击“血缘”按钮，打开元数据的血缘分析可视化界面，展示元数据向上父类追溯关联关系图谱。 </p>
					                                            ...
					                                            <div class="he_c2p4glle fl">
					                                                ...
					                                                <div class="he_c2p4glp1 wow g_fadeup1">
					                                                    ...
					                                                    <p>在检索元数据列表中，对选中元数据，在右侧操作列，点击“影响”按钮，打开元数据的影响分析可视化界面，展示元数据向下子类影响关联关系图谱
					                                                </div>
					                                            ...
					                                            <div class="he_c2p4glle fl">
					                                                ...
					                                                <div class="he_c2p4glp1 wow g_fadeup1">
					                                                    ...
					                                                    <p>在检索元数据列在检索元数据列表中，对选中元数据，在右侧操作列，点击“全链”按钮,打开元数据的全链分析可视化界面，展示元数据向上父类追溯、向下子类影响全面关联关系图谱。        </p>
