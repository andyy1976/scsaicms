...
{   document.getElementById("list").innerHTML = "";
	//var url = document.location.protocol + "://"+window.location.host+root+"/home.php?m=Guestbook&a=show&page="+no;
		var url =  "http://"+window.location.host+root+"/home.php?m=Guestbook&a=show&page="+no;
	//alert(url);
...
function AddNew() {
    ...
    //addNew.open("POST",document.location.protocol + "://" + window.location.host+root+"/home.php?m=Guestbook&a=update",false); 
      addNew.open("POST", "http://" + window.location.host+root+"/home.php?m=Guestbook&a=update",false); 
