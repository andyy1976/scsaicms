...
{   document.getElementById("list").innerHTML = "";
	var url = document.location.protocol + "://" + window.location.host+root+"/index.php?m=Pl&a=index&aid="+aid+"&page="+no;
	//alert(url);
...
function AddNew() {
    ...
    addNew.open("POST",document.location.protocol + "://"+window.location.host+root+"/index.php?m=Pl&a=update",false); 
