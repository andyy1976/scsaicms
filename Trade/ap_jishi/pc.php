...
$appid ="13661068044";			//https://open.alipay.com 账户中心->密钥管理->开放平台密钥，填写添加了电脑网站支付的应用的APPID
insertToLogRoot("alipayapi.php",$appid);
$returnUrl = 'http://localhost/Trade/ap_jishi/return_url.php';     //付款成功后的同步回调地址
$notifyUrl = 'http://localhost/index.php/Public/shouquan';     //付款成功后的异步回调地址
